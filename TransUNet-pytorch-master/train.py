...
from nets.transunet_training import (get_lr_scheduler, set_optimizer_lr,
                                 weights_init)
...
if __name__ == "__main__":
    ...
    model = TransUNet(img_dim=input_shape[0], in_channels=3, out_channels=128, head_num=12, mlp_dim=3072, block_num=12,
                      patch_dim=16, class_num=num_classes)
